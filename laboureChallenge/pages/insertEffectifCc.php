...
<div class="container">
    ...
    <div class="panel panel-primary barRecherche">
        ...
        <div class="panel-body">
            <form method="post" action="insertEffectifCc.php" class="form" enctype="multipart/form-data">

                <div class="form-group">
                    <label for="nom">Nom et prénom :</label>
                    <select name="chargeC" class="form-control" id="selectChargeC">
                </div>
                <?php
...
<?php
 ...
 if (isset($_POST['submit'])) {
    ...
    if (!empty($nom)  && !empty($date) && !empty($montant)) //&& !empty($moisHonoraire)
    {
